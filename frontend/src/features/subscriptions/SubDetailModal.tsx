...
function SubDetailContent({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md" style={{ animation: 'fadeUp 0.35s ease both' }}>
        <GlassCard hairline className="max-h-[85vh] overflow-y-auto p-8">
          {/* close */}
          <button
            onClick={onClose}
            aria-label="Close"
            className="absolute right-4 top-4 rounded-full border border-line px-2.5 py-1 text-sm text-ink-muted transition hover:border-danger/40 hover:text-danger"
          >
            ×
          </button>
          ...
          <div className="flex flex-col items-center pt-2 text-center">
            ...
            {/* the countdown — alive */}
            <p className="numeric mt-7 text-[10px] uppercase tracking-[0.28em] text-ink-faint">Next charge</p>
            <p
